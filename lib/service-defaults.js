...
const SHARED = {
  intro: {
    ...
    image: {
      url: 'https://mostafijemon.com/wp-content/uploads/2025/05/wordpress-website-design.png',
      alt: 'Service preview',
    },
    ctaText: 'Get Started',
    ctaUrl: '/contact',
...
export const SERVICE_DEFAULTS = {
  'website-design': svc(
    ...
    'https://mostafijemon.com/wp-content/uploads/2025/05/wordpress-website-design.png',
  ),
  seo: svc(
    {
