...
export const MY_STORY_DEFAULTS = {
  ...
  story: {
    ...
    image: {
      url: 'https://mostafijemon.com/wp-content/uploads/2025/05/mostafij-emon-website-designer-near-me.png',
...
export const PORTFOLIO_PAGE_DEFAULTS = {
  ...
  items: [
    ...
    { url: 'https://www.emergencydentalcenter.com/', image: 'https://mostafijemon.com/wp-content/uploads/2025/01/Emergency-Dentists-in-Greater-Houston.png', alt: 'Emergency Dental Center WordPress website design by Mostafij Emon', category: 'Emergency Dentistry', title: 'Emergency Dental Center' },
    { url: 'https://careplus24er.com/', image: 'https://mostafijemon.com/wp-content/uploads/2025/01/Care-Plus-Emergency-Room.png', alt: 'Care Plus Emergency Room WordPress website design by Mostafij Emon', category: 'Emergency Care', title: 'Care Plus Emergency Room' },
    { url: 'https://www.aggiesafety.com/', image: 'https://mostafijemon.com/wp-content/uploads/2025/01/Aggie-safety.png', alt: 'Aggie Safety WordPress website design by Mostafij Emon', category: 'Safety Training', title: 'Aggie Safety' },
    { url: 'https://divahairbraidings.com/', image: 'https://mostafijemon.com/wp-content/uploads/2025/01/hair-braids-shop-near-me.png', alt: 'Diva Hair Braidings WordPress website design by Mostafij Emon', category: 'Beauty & Salon', title: 'Diva Hair Braidings' },
    { url: 'https://gentlepediatrics.com/', image: 'https://mostafijemon.com/wp-content/uploads/2025/01/Gentle-Pediatrics.png', alt: 'Gentle Pediatrics WordPress website design by Mostafij Emon', category: 'Pediatric Clinic', title: 'Gentle Pediatrics' },
    { url: 'https://pediatricpod.com/', image: 'https://mostafijemon.com/wp-content/uploads/2025/01/Pediatric-Pod-Concierge-Pediatrics.png', alt: 'Pediatric Pod WordPress website design by Mostafij Emon', category: 'Concierge Pediatrics', title: 'Pediatric Pod' },
  ],
  logos: {
    ...
    items: [
      ...
      { url: 'https://mostafijemon.com/wp-content/uploads/2025/01/care-plus-emergency-room.jpg', alt: 'CarePlus 24 ER website client logo' },
      { url: 'https://mostafijemon.com/wp-content/uploads/2025/01/brazos-smiles.jpg', alt: 'Brazos Smiles website client logo' },
      { url: 'https://mostafijemon.com/wp-content/uploads/2025/01/big-country-welding.jpg', alt: 'Big Country Welding website client logo' },
      { url: 'https://mostafijemon.com/wp-content/uploads/2025/01/auspicious-lab.jpg', alt: 'Auspicious Lab website client logo' },
      { url: 'https://mostafijemon.com/wp-content/uploads/2025/01/appna.jpg', alt: 'APPNA STC website client logo' },
      { url: 'https://mostafijemon.com/wp-content/uploads/2025/01/aggiesafety.jpg', alt: 'Aggie Safety website client logo' },
    ],
  },
  reviews: {
...
export const BLOGS_DEFAULTS = {
  ...
  posts: [
    { thumb: 'SEO', category: 'SEO', title: 'How to Rank a Small Business Website on the First Page of Google', excerpt: 'A practical, beginner-friendly guide to keyword research, on-page SEO, and the local signals that move you up the rankings.', url: '/contact' },
    { thumb: 'WEB', category: 'Web Design', title: '7 Signs Your Website Needs a Redesign in 2026', excerpt: "Slow load times, poor mobile experience, high bounce rates — here's how to know it's time for a refresh, and what to fix first.", url: '/contact' },
    { thumb: 'LOC', category: 'Local SEO', title: 'Google Business Profile: The Free Tool Most Local Businesses Underuse', excerpt: 'Step-by-step tips to optimize your GMB listing and start appearing in the local map pack for nearby searches.', url: '/contact' },
    { thumb: 'WOR', category: 'WordPress', title: 'Divi vs Elementor: Which Page Builder Is Right for You?', excerpt: 'An honest comparison of the two most popular WordPress builders, with recommendations based on your goals and skill level.', url: '/contact' },
    { thumb: 'PER', category: 'Performance', title: 'Why Website Speed Matters for SEO and Sales (and How to Fix It)', excerpt: 'How page speed affects rankings and conversions, plus the highest-impact tweaks to make your WordPress site faster.', url: '/contact' },
    { thumb: 'DIG', category: 'Digital Marketing', title: 'A Simple Marketing Funnel Every Small Business Should Have', excerpt: 'From first click to repeat customer — a clear, no-fluff framework you can set up without a big budget.', url: '/contact' },
  ],
